...
namespace Antanidoss.Specification.Implementation.Specifications
{
        ...
        where TEntity : class
    {
        ...
        public AndSpecification(Specification<TEntity> firstSpecification, Specification<TEntity> secondSpecification)
        {
        ...
        {
            return _firstSpecification.ToExpression().And(_secondSpecification);
        }
    }
}
